          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
             ...
             <div class="text-right">
              <a href="orderanpelanggan.php?id_pelanggan=<?php if(isset($data['id_pelanggan'])){echo $data['id_pelanggan'];}else{echo $data1['id_pelanggan'];}?>" class="btn btn-sm btn-warning">Kembali <i class="fa fa-arrow-circle-right"></i></a>
