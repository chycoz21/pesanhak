          ...
          <section class="content">
            ...
            <div class="row">
              ...
              <section class="col-lg-12 connectedSortable">
                ...
                <div class="box-body">
                  <div class="form-panel">
                    <table id="example" class="table table-hover table-bordered">
                     ...
                     $sql  		= "SELECT * FROM tb_pelanggan inner join (tb_transaksi inner join tb_kurir on tb_transaksi.kurir = tb_kurir.id_kurir) on tb_pelanggan.id_pelanggan = tb_transaksi.pengirim where no_transaksi='".$no_transaksi."'";                        
               ...
               $sql1  		= "SELECT * FROM tb_transaksi inner join tb_pelanggan on tb_transaksi.pengirim = tb_pelanggan.id_pelanggan where no_transaksi='".$no_transaksi."'";                        
              ...
              <tr>
                <td width="250">Alamat Asal</td>
                <td width="700" colspan="1"><?php echo $data1['alamat_asal'];?></td>
              </tr>
              <tr>
                <td>Alamat Tujuan</td>
              ...
              <tr>
                <td>Penerima</td>
                <td><?php echo $data1['penerima'];?></td>
              </tr>
              <tr>
                <td>No Hp Penerima</td></td>
                <td><?php echo $data1['no_hp_penerima'];?></td>
              </tr>
              <tr>
                <td>Status</td></td>
