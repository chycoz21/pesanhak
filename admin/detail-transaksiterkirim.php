                ...
                <div class="box-body">
                  <div class="form-panel">
                    <table id="example" class="table table-hover table-bordered">
                      ...
                      $sql  		= "SELECT * FROM tb_kurir inner join (tb_transaksi inner join tb_pelanggan on tb_transaksi.pengirim = tb_pelanggan.id_pelanggan) on tb_kurir.id_kurir = tb_transaksi.kurir where no_transaksi='".$id."'";                        
