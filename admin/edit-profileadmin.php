                ...
                <div class="box-body">
                  <form class="form-horizontal style-form" action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input value="<?php echo $data['nama_admin'];?>" name="nama_lengkap" type="text" id="nama_lengkap" class="form-control" placeholder="Nama Lengkap" autocomplete="off" required />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Username Admin</label>
                      <div class="col-sm-4">
                        <input value="<?php echo $data['username_admin'];?>" name="username_admin" type="text" id="username_admin" class="form-control" placeholder="Username Kurir" autocomplete="off" required />   
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <a href="detail-admin.php" class="btn btn-sm btn-danger">Batal</a>
                      </div> 
                    </div>
                  </form>
                </div><!-- /.box-body -->
