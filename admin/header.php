...
<header class="main-header">
	...
	<a href="index.php" class="logo">
		...
		<span class="logo-mini"><b>PesanHak - Admin</b></span>
		<!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>PesanHak - Admin</b></span>
	</a>
	<!-- Header Navbar: style can be found in header.less -->
	<nav class="navbar navbar-static-top" role="navigation" style="background-color: #49BAAE";>
