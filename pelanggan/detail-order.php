          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-panel">
                    <table id="example" class="table table-hover table-bordered">
                     ...
                     $sql  		= "SELECT * FROM tb_transaksi inner join tb_kurir on tb_transaksi.kurir = tb_kurir.id_kurir where pengirim='".$_SESSION['id']."' and no_transaksi='".$no_transaksi."'";                        
                ...
                $sql1  		= "SELECT * FROM tb_transaksi where pengirim='".$_SESSION['id']."' and no_transaksi='".$no_transaksi."'";                        
