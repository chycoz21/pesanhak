      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <div class="table table-responsive table-hover">
            ...
            $sql  		= "SELECT * FROM tb_transaksi inner join tb_kurir on tb_transaksi.kurir = tb_kurir. id_kurir where pengirim='".$_SESSION['id']."' and status='Terkirim' order by no_transaksi desc";                        
           ...
           <?php 
               while($data = mysqli_fetch_array($query)){
                ...
                <td>';
                if($data['penilaian']==0){
                 echo'<a href=beripenilaian.php?no_transaksi='.$data['no_transaksi'].'>Beri Penilaian</a>';
               }
             else{
               echo $data['penilaian'];
             }
             echo'	</td>
             <td style="text-align:center;"><a href=detail-orderterkirim.php?no_transaksi='.$data['no_transaksi'].'>Lihat Detail</a></td>
             </tr>';
           }
           ?>
